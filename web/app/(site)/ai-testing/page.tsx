...
export const metadata = {
  title: "AI Testing (ISTQB CT-AI) — Ôn thi & tài liệu",
  description:
    "Chuyên mục ôn thi ISTQB Certified Tester AI Testing (CT-AI): tài liệu tự đúc kết theo từng chương, dễ hiểu, phục vụ thi đỗ.",
};
  ...
  return (
    <div className="container-content py-10 md:py-14">
      <nav className="text-sm text-[color:var(--faint)] mb-4 max-w-4xl mx-auto">
        ...
        <span className="mx-2">/</span>
        <span className="text-slate-200">Chương 1 · Mục 1.1.1</span>
      </nav>
      ...
      <article className="mx-auto max-w-4xl rounded-3xl bg-[color:var(--bg2)] text-[color:var(--ink)] px-6 py-10 md:px-12 md:py-14 ring-1 ring-white/10 shadow-2xl shadow-black/40">
        ...
        <div className="mt-6 rounded-2xl border border-brand-500/30 bg-brand-500/10 p-5 space-y-2">
          <p className="m-0 text-[color:var(--muted)]">
            ...
            (LO AI-1.1.1 · mức K2 – Hiểu): <em>phân biệt</em> hệ thống dựa trên
            AI với hệ thống truyền thống.
          </p>
          <div className="text-[color:var(--muted)]">
            <p className="m-0">
              💡 <strong className="text-[color:var(--ink)]">Ý cốt lõi:</strong>{" "}
              vì sao phải kiểm thử khác?
            </p>
        ...
        <div className="mt-4 space-y-4 text-[color:var(--muted)] leading-relaxed">
          <p className="m-0">
            ...
            Phần mềm thường: cùng một đầu vào luôn cho cùng đầu ra. Hệ AI giải
            quyết vấn đề bằng <strong>bộ ba</strong>: suy luận xác suất
            (probabilistic reasoning), suy luận thống kê (statistical inference)
            và nhận dạng mẫu (pattern recognition). Nhờ đó AI{" "}
            <strong>xử lý được sự bất định (uncertainty) và mơ hồ (ambiguity)</strong>{" "}
            phức tạp tốt hơn — đánh đổi là đầu ra <em>không phải lúc nào cũng đoán
            trước được</em>.{" "}
            <em>
          ...
          <p className="m-0">
            ...
            Mô hình học sâu có thể chứa <strong>hàng tỉ tham số</strong> → khó
            biết vì sao nó ra quyết định. Nguy hiểm ở lĩnh vực hệ trọng: y tế,
            tài chính, quốc phòng, giao thông. Vì vậy tính minh bạch
            (transparency) và giải thích được (explainability) đang là{" "}
            <strong>trọng tâm của các quy định về AI</strong> (xem thêm mục
            2.1.1).
          </p>
          <p className="m-0">
            <strong className="text-[color:var(--ink)]">
            ...
            Hệ thường tĩnh, muốn đổi hành vi phải cập nhật thủ công. Hệ AI tự
            học, liên tục cải thiện khi gặp dữ liệu mới →{" "}
            <strong>đặc biệt mạnh trong môi trường động</strong>, thay đổi liên
            tục. Đổi lại, phải <strong>giám sát liên tục</strong> để nó không
        ...
        <div className="mt-6 rounded-2xl border border-emerald-500/30 bg-emerald-500/10 p-6">
          <h3 className="mt-0 text-lg font-bold text-emerald-300">
            🔍 Vì sao tester phải quan tâm
          </h3>
          <p className="mt-2 mb-0 text-[color:var(--muted)]">
            Vì đầu ra xác suất + hộp đen + tự trôi →{" "}
            <strong>không có &quot;một đáp án đúng duy nhất&quot;</strong> để so.
            Đây là gốc rễ khiến các phần sau phải dùng cách tiếp cận{" "}
            <strong>thống kê</strong>, <strong>test oracle riêng cho AI</strong>,
            và <strong>kiểm thử drift</strong>.
          </p>
        </div>

        {/* Nhớ 1 câu */}
        <div className="mt-6 rounded-2xl card-surface p-6">
          ...
          <div className="mt-3 space-y-2 text-[color:var(--ink)] leading-relaxed">
            ...
            <p className="m-0">
              <strong className="text-[color:var(--metal)]">Hệ AI</strong> = dữ
              liệu + xác suất + hộp đen + tự học
            </p>
          </div>
        </div>

        {/* Thuật ngữ Anh–Việt (component client: có nút loa + đọc tất cả) */}
        <TermGlossary
          terms={[
        ...
        <div className="mt-8 rounded-2xl border border-indigo-400/30 bg-indigo-500/10 p-6">
          ...
          <p className="mt-3 mb-0 text-[color:var(--ink)]">
            ...
            old module, which statement <strong>correctly describes</strong> the
            new system?
          </p>
          <ul className="mt-3 mb-0 space-y-1.5 text-[color:var(--muted)] list-none pl-0">
            <li>
              <strong>a)</strong> Given the same input record, it always returns
              the same score in a deterministic way.
            </li>
            <li>
              <strong>b)</strong> Its results are based on patterns learned from
              data and are probabilistic, so they are not always predictable.
            </li>
            <li>
            ...
            <li>
              <strong>d)</strong> It needs no monitoring after deployment because
          ...
          <details className="mt-3">
            ...
            <div className="mt-2 text-sm text-[color:var(--muted)] space-y-1">
              <p className="m-0">
                ...
                if-then-else cố định bằng một mô hình học máy huấn luyện từ dữ
                liệu lịch sử. So với module cũ, phát biểu nào{" "}
                <strong>mô tả đúng</strong> hệ thống mới?
              </p>
              <p className="m-0">
                <strong>a)</strong> Cùng một hồ sơ đầu vào luôn cho cùng một điểm
                số một cách tất định.
              </p>
              <p className="m-0">
                <strong>b)</strong> Kết quả dựa trên mẫu học từ dữ liệu và mang
                tính xác suất, không phải lúc nào cũng đoán trước được.
              </p>
              <p className="m-0">
                <strong>c)</strong> Cách hệ ra quyết định luôn minh bạch và dễ
                giải thích hơn module cũ.
              </p>
              <p className="m-0">
                <strong>d)</strong> Hệ không cần giám sát sau khi triển khai vì
                hành vi đã cố định.
              </p>
            </div>
          </details>
          ...
          <details className="mt-3 group">
            ...
            <div className="mt-2 text-sm space-y-2">
              <p className="m-0 rounded-lg border border-emerald-500/40 bg-emerald-500/15 px-3 py-2 text-emerald-200 font-medium">
                ...
                <strong>b</strong> — Mô hình ML học mẫu từ dữ liệu và suy luận
                theo xác suất → đầu ra không tất định.
              </p>
              <div className="space-y-1 text-[color:var(--muted)]">
                ...
                <p className="m-0">
                  <strong>d</strong> sai — hệ tự học cần giám sát liên tục để
                  không bị trôi.
                </p>
              </div>
            </div>
          ...
          <p className="mt-3 mb-0 text-xs italic text-[color:var(--faint)]">
            Đề để tiếng Anh cho sát đề thi thật; phần giải thích để tiếng Việt
            cho dễ hiểu. Câu hỏi do maiqai.com tự soạn theo phong cách đề — trong
            đề mẫu chính thức, LO AI-1.1.1 tương ứng với Câu 1 (Sample Exam Set
            A).
          </p>
        </div>
        ...
        <p className="mt-8 text-xs italic text-[color:var(--faint)] leading-relaxed border-t border-[color:var(--line)] pt-4">
          ...
          Conventional Systems&quot;, trang 15 — ISTQB® Certified Tester AI
