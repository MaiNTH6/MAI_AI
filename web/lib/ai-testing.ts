...
export const aiChapters: AiChapter[] = [
  {
    ...
    sections: [
      ...
      { slug: "generative-ai", code: "1.1.4", title: "Generative AI", hasContent: true },
      { slug: "phan-cung-ml", code: "1.1.5", title: "Phần cứng cho hệ thống ML", hasContent: true },
      { slug: "phat-trien-hosting-mo-hinh", code: "1.1.6", title: "Phát triển & lưu trữ mô hình AI", hasContent: true },
      { slug: "ml-framework", code: "1.1.7", title: "Framework phát triển ML", hasContent: true },
      { slug: "quy-dinh-tieu-chuan", code: "1.1.8", title: "Quy định & tiêu chuẩn cho AI", hasContent: true },
    ],
  },
  {
